...
import {$ConduitRegistryEvent} from "com.almostreliable.kubeio.event.ConduitRegistryEvent"
...
export namespace EnderIOEvents {
function conduits(handler: (event: $ConduitRegistryEvent) => void): void
}
