 ...
 * types for convenience unless there's a naming conflict.
 */
export type $HiveDebugPayload$HiveInfo$$Type = ({"pos"?: $BlockPos$$Type, "occupantCount"?: integer, "hiveType"?: StringJS, "honeyLevel"?: integer, "sedated"?: boolean}) | ([pos?: $BlockPos$$Type, occupantCount?: integer, hiveType?: StringJS, honeyLevel?: integer, sedated?: boolean]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundDamageEventPacket$$Type = ({"sourceDirectId"?: integer, "sourceCauseId"?: integer, "sourceType"?: $Holder$$Type<($DamageType)>, "sourcePosition"?: ($Vec3$$Type)?, "entityId"?: integer}) | ([sourceDirectId?: integer, sourceCauseId?: integer, sourceType?: $Holder$$Type<($DamageType)>, sourcePosition?: ($Vec3$$Type)?, entityId?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
