...
export class $CertusQuartzClusterBlock extends $AEBaseBlock implements $SimpleWaterloggedBlock$$Interface {
 ...
 */
export type $CertusQuartzClusterBlock$$Original = $CertusQuartzClusterBlock;}
...
import {$Item} from "net.minecraft.world.item.Item"
import {$MapCodec} from "com.mojang.serialization.MapCodec"
import {$AEDecorativeBlock} from "appeng.decorative.AEDecorativeBlock"
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $NotSoMysteriousCubeBlock$$Original = $NotSoMysteriousCubeBlock;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $BuddingCertusQuartzBlock$$Original = $BuddingCertusQuartzBlock;}
...
import {$IdMapper} from "net.minecraft.core.IdMapper"
import {$Item} from "net.minecraft.world.item.Item"
import {$QuartzGlassBlock} from "appeng.decorative.solid.QuartzGlassBlock"
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $QuartzLampBlock$$Original = $QuartzLampBlock;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $QuartzGlassBlock$$Original = $QuartzGlassBlock;}
