 ...
 * types for convenience unless there's a naming conflict.
 */
export type $IERecipeTypes$TypeWithClass$$Type<T> = ({"recipeClass"?: $Class$$Type<(T)>, "type"?: $DeferredHolder$$Type<($RecipeType$$Type<(never)>), ($RecipeType$$Type<(T)>)>}) | ([recipeClass?: $Class$$Type<(T)>, type?: $DeferredHolder$$Type<($RecipeType$$Type<(never)>), ($RecipeType$$Type<(T)>)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $MultiblockRecipe$RecipeMultiplier$$Type = ({"timeModifier"?: $DoubleSupplier$$Type, "energyModifier"?: $DoubleSupplier$$Type}) | ([timeModifier?: $DoubleSupplier$$Type, energyModifier?: $DoubleSupplier$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
