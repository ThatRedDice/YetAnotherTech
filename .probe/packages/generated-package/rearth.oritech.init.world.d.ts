 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ResourceNodeFeatureConfig$$Type = ({"overlayBlock"?: $ResourceLocation$$Type, "nodeOreChance"?: float, "boulderRadius"?: integer, "overlayHeight"?: integer, "nodeOres"?: $List$$Type<($ResourceLocation$$Type)>, "nodeSize"?: integer, "boulderOres"?: $List$$Type<($ResourceLocation$$Type)>}) | ([overlayBlock?: $ResourceLocation$$Type, nodeOreChance?: float, boulderRadius?: integer, overlayHeight?: integer, nodeOres?: $List$$Type<($ResourceLocation$$Type)>, nodeSize?: integer, boulderOres?: $List$$Type<($ResourceLocation$$Type)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
