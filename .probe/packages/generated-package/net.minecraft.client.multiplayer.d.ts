...
public "handler$dko000$journeymap$handleLogin"(arg0: $ClientboundLoginPacket$$Type, arg1: $CallbackInfo$$Type): void
...
public "handler$dok000$ftbchunks$handleChunkBlocksUpdateFTBC"(packet: $ClientboundSectionBlocksUpdatePacket$$Type, ci: $CallbackInfo$$Type): void
public "handleLevelChunkWithLight"(arg0: $ClientboundLevelChunkWithLightPacket$$Type): void
public "handler$dok000$ftbchunks$handleLevelChunkFTBC"(packet: $ClientboundLevelChunkWithLightPacket$$Type, ci: $CallbackInfo$$Type): void
...
public "handler$dok000$ftbchunks$handleBlockUpdateFTBC"(packet: $ClientboundBlockUpdatePacket$$Type, ci: $CallbackInfo$$Type): void
...
public "handler$dko000$journeymap$handleDisguisedChat_onClientChatEventReceived"(arg0: $ClientboundDisguisedChatPacket$$Type, arg1: $CallbackInfo$$Type): void
...
public "handler$zbo000$immersive_aircraft$onEntityPassengersSetInject"(packet: $ClientboundSetPassengersPacket$$Type, ci: $CallbackInfo$$Type): void
...
public "handler$dko000$journeymap$handleRespawn"(arg0: $ClientboundRespawnPacket$$Type, arg1: $CallbackInfo$$Type): void
...
public "handler$dlh000$journeymap$jm$SendUnsignedCommandMixin"(arg0: StringJS, arg1: $CallbackInfoReturnable$$Type): void
...
public "handler$bmi000$patchouli$onSync"(arg0: $ClientboundUpdateAdvancementsPacket$$Type, arg1: $CallbackInfo$$Type): void
...
export class $ClientLevel extends $Level implements $ExtendedWorld$$Interface, $ClientLevelKJS$$Interface, $ClientWorldAccessor$$Interface, $BiomeSeedProvider$$Interface, $ChunkTrackerHolder$$Interface {
...
import {$AccessorMultiPlayerGameMode$$Interface} from "xfacthd.framedblocks.mixin.client.AccessorMultiPlayerGameMode"
...
export class $MultiPlayerGameMode implements $PlayerControllerAccess$$Interface, $AccessorMultiPlayerGameMode$$Interface {
...
public "handler$chd000$inventoryprofilesnext$clickCreativeStack"(arg0: $ItemStack$$Type, arg1: integer, arg2: $CallbackInfo$$Type): void
