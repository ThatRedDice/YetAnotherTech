 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModFileScanData$AnnotationData$$Type = ({"clazz"?: $Type$$Type, "annotationData"?: $Map$$Type<(StringJS), (any)>, "annotationType"?: $Type$$Type, "targetType"?: $ElementType$$Type, "memberName"?: StringJS}) | ([clazz?: $Type$$Type, annotationData?: $Map$$Type<(StringJS), (any)>, annotationType?: $Type$$Type, targetType?: $ElementType$$Type, memberName?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
