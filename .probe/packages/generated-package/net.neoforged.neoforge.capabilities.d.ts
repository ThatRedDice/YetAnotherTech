...
import {$BlockCapabilityExtension$$Interface} from "com.supermartijn642.entangled.extensions.BlockCapabilityExtension"
...
public static get "allProxyable"(): $List<($BlockCapability<(never), (never)>)>
get "proxyable"(): boolean
public static get "all"(): $List<($BlockCapability<(never), (never)>)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
public static get "all"(): $List<($ItemCapability<(never), (never)>)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
public "entangled_getRegisteredCapabilities"(): $Set
...
public static get "all"(): $List<($EntityCapability<(never), (never)>)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
