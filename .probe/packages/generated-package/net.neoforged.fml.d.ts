 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $DeferredWorkQueue$$Original = $DeferredWorkQueue;}
...
constructor(senderModId: StringJS, modId: StringJS, method: StringJS, messageSupplier: $Supplier$$Type<(never)>)

/**
 * 
 * @deprecated
 */
public "getSenderModId"(): StringJS
public "equals"(arg0: any): boolean
public "toString"(): StringJS
public "method"(): StringJS
public "hashCode"(): integer
/**
 * 
 * @deprecated
 */
public "getMethod"(): StringJS
public "messageSupplier"(): $Supplier<(never)>
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $InterModComms$IMCMessage$$Type = ({"senderModId"?: StringJS, "method"?: StringJS, "messageSupplier"?: $Supplier$$Type<(never)>, "modId"?: StringJS}) | ([senderModId?: StringJS, method?: StringJS, messageSupplier?: $Supplier$$Type<(never)>, modId?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $InterModComms$IMCMessage$$Original = $InterModComms$IMCMessage;}
