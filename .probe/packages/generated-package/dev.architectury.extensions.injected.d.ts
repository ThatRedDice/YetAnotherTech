...
export interface $InjectedBucketItemExtension$$Interface {
}

export class $InjectedBucketItemExtension implements $InjectedBucketItemExtension$$Interface {
 "arch$getFluid"(): $Fluid
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $InjectedBucketItemExtension$$Original = $InjectedBucketItemExtension;}
