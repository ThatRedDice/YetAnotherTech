...
export interface $SlidingDoorBlockEntityAccessor$$Interface {

(): $LerpedFloat$$Type
get "animation"(): $LerpedFloat
}

export class $SlidingDoorBlockEntityAccessor implements $SlidingDoorBlockEntityAccessor$$Interface {
 ...
 */
export type $SlidingDoorBlockEntityAccessor$$Original = $SlidingDoorBlockEntityAccessor;}
