 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BlacklistModifier$$Type = ({"blacklistedBiomes"?: $HolderSet$$Type<($Biome)>, "feature"?: $Holder$$Type<($PlacedFeature)>}) | ([blacklistedBiomes?: $HolderSet$$Type<($Biome)>, feature?: $Holder$$Type<($PlacedFeature)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
