 ...
 * types for convenience unless there's a naming conflict.
 */
export type $StackAttributeModifiers$$Type = ({"modifiers"?: $List$$Type<($StackAttributeModifiers$Entry$$Type)>, "showInTooltip"?: boolean}) | ([modifiers?: $List$$Type<($StackAttributeModifiers$Entry$$Type)>, showInTooltip?: boolean]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $StackAttributeModifiers$Entry$$Type = ({"modifier"?: $AttributeModifier$$Type, "attribute"?: $Holder$$Type<($Attribute)>, "slots"?: $EntitySlotGroup$$Type}) | ([modifier?: $AttributeModifier$$Type, attribute?: $Holder$$Type<($Attribute)>, slots?: $EntitySlotGroup$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
