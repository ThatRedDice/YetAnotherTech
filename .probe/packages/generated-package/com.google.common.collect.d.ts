 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $HashMultimapGwtSerializationDependencies$$Original<K, V> = $HashMultimapGwtSerializationDependencies<(K), (V)>;}
...
export class $ForwardingSet<E> extends $ForwardingCollection<(E)> implements $Set$$Interface<(E)> {
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ForwardingSet$$Original<E> = $ForwardingSet<(E)>;}
...
export class $AbstractMapBasedMultimap<K, V> extends $AbstractMultimap<(K), (V)> implements $Serializable$$Interface {
public "remove"(key: any, value: any): boolean
public "put"(key: K, value: V): boolean
public "equals"(obj: any): boolean
public "values"(): $Collection<(V)>
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AbstractMapBasedMultimap$$Original<K, V> = $AbstractMapBasedMultimap<(K), (V)>;}
...
export class $AbstractMultimap<K, V> implements $Multimap$$Interface<(K), (V)> {
public "remove"(key: any, value: any): boolean
public "size"(): integer
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AbstractMultimap$$Original<K, V> = $AbstractMultimap<(K), (V)>;}
 ...
 * @deprecated
 */
public "replaceValues"(key: K, values: $Iterable$$Type<(V)>): $ImmutableSet<(V)>
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ImmutableMultisetGwtSerializationDependencies$$Original<E> = $ImmutableMultisetGwtSerializationDependencies<(E)>;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ImmutableMultiset$Builder$$Original<E> = $ImmutableMultiset$Builder<(E)>;}
...
public "clear"(): void
public "isEmpty"(): boolean
public "putAll"(key: any, values: $Iterable$$Type): boolean
public "putAll"(multimap: $Multimap$$Type): boolean
public "forEach"(action: $BiConsumer$$Type): void
public "containsKey"(key: any): boolean
...
public "removeAll"(key: any): $Set
public "asMap"(): $Map
public "containsEntry"(key: any, value: any): boolean
public "replaceValues"(key: any, values: $Iterable$$Type): $Set
get "empty"(): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $HashMultimap$$Original<K, V> = $HashMultimap<(K), (V)>;}
...
export class $AbstractSetMultimap<K, V> extends $AbstractMapBasedMultimap<(K), (V)> implements $SetMultimap$$Interface<(K), (V)> {
public "get"(key: K): $Set<(V)>
public "equals"(obj: any): boolean
public "entries"(): $Collection
public "removeAll"(key: any): $Set<(V)>
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AbstractSetMultimap$$Original<K, V> = $AbstractSetMultimap<(K), (V)>;}
...
public "subList"(fromIndex: integer, toIndex: integer): $ImmutableList<(E)>
public "iterator"(): $UnmodifiableIterator<(E)>
