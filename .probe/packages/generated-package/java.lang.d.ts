...
get "daemon"(): boolean
get "alive"(): boolean
public static set "defaultUncaughtExceptionHandler"(value: $Thread$UncaughtExceptionHandler$$Type)
get "uncaughtExceptionHandler"(): $Thread$UncaughtExceptionHandler
set "name"(value: StringJS)
public static get "allStackTraces"(): $Map<($Thread), (($StackTraceElement)[])>
get "id"(): long
get "state"(): $Thread$State
public static get "defaultUncaughtExceptionHandler"(): $Thread$UncaughtExceptionHandler
...
get "name"(): StringJS
public static get "platformClassLoader"(): $ClassLoader
public static get "systemClassLoader"(): $ClassLoader
...
get "declaredAnnotations"(): ($Annotation)[]
get "sealed"(): boolean
public static get "packages"(): ($Package)[]
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
