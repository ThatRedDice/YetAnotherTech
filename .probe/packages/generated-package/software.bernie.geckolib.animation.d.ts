 ...
 */
export type $AnimationPoint$$Type = ({"keyFrame"?: $Keyframe$$Type<(never)>, "animationStartValue"?: double, "transitionLength"?: double, "animationEndValue"?: double, "currentTick"?: double}) | ([keyFrame?: $Keyframe$$Type<(never)>, animationStartValue?: double, transitionLength?: double, animationEndValue?: double, currentTick?: double]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AnimationPoint$$Original = $AnimationPoint;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $CustomInstructionKeyframeEvent$$Original<T> = $CustomInstructionKeyframeEvent<(T)>;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $SoundKeyframeEvent$$Original<T> = $SoundKeyframeEvent<(T)>;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $KeyFrameEvent$$Original<T, E> = $KeyFrameEvent<(T), (E)>;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ParticleKeyframeEvent$$Original<T> = $ParticleKeyframeEvent<(T)>;}
...
import {$AnimationPoint} from "software.bernie.geckolib.animation.keyframe.AnimationPoint"
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AnimationPointQueue$$Original = $AnimationPointQueue;}
